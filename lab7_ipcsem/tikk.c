...
int main() {
    ...
    struct sembuf down = {0, -1, 0}; //első paraméter: apa szemafora
    struct sembuf up = {0, 1, 0}; //első paraméter: apa szemafora
    struct sembuf down1 = {1, -1, 0}; //első paraméter: fiú szemafora
    struct sembuf up1 = {1, 1, 0}; //első paraméter: fiú szemafora
